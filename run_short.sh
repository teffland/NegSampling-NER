...
do
    ...
    echo "python main.py -dd data/conll2003/${lang}_P-1000_short -cd save_${lang}_P-1000_short -rd resource --model-name $model_name --batch_size $batch_size -en 50 &> runs/21-06-01_run_${lang}_P-1000_short.log"
...
do
    ...
    echo "python main.py -dd data/ontonotes5/${lang}_P-1000_short -cd save_${lang}_P-1000_short -rd resource --model-name $model_name --batch_size $batch_size -en 50 &> runs/21-06-01_run_${lang}_P-1000_short.log"
